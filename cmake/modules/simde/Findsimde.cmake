find_path(simde_INCLUDE_DIR NAMES simde/simde-common.h REQUIRED)
...
if(NOT TARGET simde::simde)
  ...
  string(
    REGEX MATCH
    "#define SIMDE_VERSION_MAJOR[ \t]+([0-9]+)"
    _match_major
    ${simde_common_h}
  )
  ...
  string(
    REGEX MATCH
    "#define SIMDE_VERSION_MINOR[ \t]+([0-9]+)"
    _match_minor
    ${simde_common_h}
  )
  ...
  string(
    REGEX MATCH
    "#define SIMDE_VERSION_MICRO[ \t]+([0-9]+)"
    _match_micro
    ${simde_common_h}
  )
  ...
  set(
    simde_VERSION
    ${simde_VERSION_MAJOR}.${simde_VERSION_MINOR}.${simde_VERSION_MICRO}
  )
endif()
